...
away.math.Quaternion.prototype.multiply = function(qa, qb) {
...
away.math.Quaternion.prototype.fromAxisAngle = function(axis, angle) {
...
away.math.Quaternion.prototype.slerp = function(qa, qb, t) {
	var w1 = qa.w, x1 = qa.x, y1 = qa.y, z1 = qa.z;
	var w2 = qb.w, x2 = qb.x, y2 = qb.y, z2 = qb.z;
...
away.math.Quaternion.prototype.lerp = function(qa, qb, t) {
	var w1 = qa.w, x1 = qa.x, y1 = qa.y, z1 = qa.z;
	var w2 = qb.w, x2 = qb.x, y2 = qb.y, z2 = qb.z;
	var len;
...
away.math.Quaternion.prototype.fromEulerAngles = function(ax, ay, az) {
...
away.math.Quaternion.prototype.toString = function() {
...
away.math.Quaternion.prototype.fromMatrix = function(matrix) {
...
away.math.Quaternion.prototype.clone = function() {
	return new away.math.Quaternion(this.x, this.y, this.z, this.w);
};
...
away.math.Quaternion.prototype.copyFrom = function(q) {
	this.x = q.x;
	this.y = q.y;
	this.z = q.z;
	this.w = q.w;
...
away.math.Quaternion.className = "away.math.Quaternion";

away.math.Quaternion.getRuntimeDependencies = function(t) {
	var p;
	p = [];
...
away.math.Quaternion.getStaticDependencies = function(t) {
	var p;
	return [];
};

away.math.Quaternion.injectionPoints = function(t) {
	var p;
	switch (t) {
		case 0:
			p = [];
