...
away.materials.methods.ShaderMethodSetup = function() {
	...
	this._iNormalMethod.addEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	this._iDiffuseMethod.addEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	this._iSpecularMethod.addEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	this._iAmbientMethod.addEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
...
away.materials.methods.ShaderMethodSetup.prototype.set_normalMethod = function(value) {
	if (this._iNormalMethod) {
		this._iNormalMethod.removeEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	}
	if (value) {
		if (this._iNormalMethod) {
		...
		value.addEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	}
...
away.materials.methods.ShaderMethodSetup.prototype.set_ambientMethod = function(value) {
	if (this._iAmbientMethod)
		this._iAmbientMethod.removeEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	if (value) {
		if (this._iAmbientMethod)
...
away.materials.methods.ShaderMethodSetup.prototype.set_shadowMethod = function(value) {
	if (this._iShadowMethod) {
		this._iShadowMethod.removeEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	}
	this._iShadowMethod = value;
	if (this._iShadowMethod) {
		this._iShadowMethod.addEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
...
away.materials.methods.ShaderMethodSetup.prototype.set_diffuseMethod = function(value) {
	if (this._iDiffuseMethod)
		this._iDiffuseMethod.removeEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	if (value) {
		if (this._iDiffuseMethod)
...
away.materials.methods.ShaderMethodSetup.prototype.set_specularMethod = function(value) {
	if (this._iSpecularMethod) {
		this._iSpecularMethod.removeEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
		if (value)
...
away.materials.methods.ShaderMethodSetup.prototype.set_iColorTransformMethod = function(value) {
	...
	if (this._iColorTransformMethod)
		this._iColorTransformMethod.removeEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
	if (!this._iColorTransformMethod || !value) {
		this.invalidateShaderProgram();
	}
	this._iColorTransformMethod = value;
	if (this._iColorTransformMethod) {
		this._iColorTransformMethod.addEventListener(away.events.ShadingMethodEvent.SHADER_INVALIDATED, $createStaticDelegate(, this.onShaderInvalidated), this);
