...
away.primitives.PrimitiveBase = function() {
	...
	this._uvDirty = true;
	away.core.base.Geometry.call(this);
	this._subGeometry = new away.core.base.CompactSubGeometry();
...
away.primitives.PrimitiveBase.prototype.get_subGeometries = function() {
	...
	return away.core.base.Geometry.prototype.getSubGeometries.call(this);
};
...
away.primitives.PrimitiveBase.prototype.clone = function() {
	...
	return away.core.base.Geometry.prototype.clone.call(this);
};
...
away.primitives.PrimitiveBase.prototype.scale = function(scale) {
	...
	away.core.base.Geometry.prototype.scale.call(this,scale);
};
...
away.primitives.PrimitiveBase.prototype.scaleUV = function(scaleU, scaleV) {
	...
	away.core.base.Geometry.prototype.scaleUV.call(this,scaleU, scaleV);
};
...
away.primitives.PrimitiveBase.prototype.applyTransformation = function(transform) {
	...
	away.core.base.Geometry.prototype.applyTransformation.call(this,transform);
};
...
$inherit(away.primitives.PrimitiveBase, away.core.base.Geometry);
...
away.primitives.PrimitiveBase.injectionPoints = function(t) {
	...
	switch (t) {
		case 1:
			p = away.core.base.Geometry.injectionPoints(t);
			break;
		case 2:
			p = away.core.base.Geometry.injectionPoints(t);
			break;
