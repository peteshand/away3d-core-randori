...
package away.core.base
{
	...
	public class SubGeometryBase
	{
        ...
        public var _indexBuffer:Vector.<IndexBuffer3D> = VectorInit.AnyClass(8);//Vector.<IndexBuffer3D> = VectorInit.AnyClass(8)
        public var _numIndices:Number = 0;
        public var _indexBufferContext:Vector.<Context3D> = VectorInit.AnyClass(8);//Vector.<Context3D> = VectorInit.AnyClass(8)
