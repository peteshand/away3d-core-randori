...
package away.materials.compilation
{
	...
	public class LightingShaderCompiler extends ShaderCompiler
	{
		...
		override public function pInitLightData():void
		{
			...
			this._pointLightVertexConstants = VectorInit.AnyClass(this._pNumPointLights );
			this._pointLightFragmentConstants = VectorInit.AnyClass(this._pNumPointLights*2 );

			if ( this.tangentSpace )
            {
				this._dirLightVertexConstants = VectorInit.AnyClass(this._pNumDirectionalLights );
				this._dirLightFragmentConstants = VectorInit.AnyClass(this._pNumDirectionalLights*2 );
			}
            else
            {
				this._dirLightFragmentConstants = VectorInit.AnyClass(this._pNumDirectionalLights*3);
            }
		}
		...
		override public function pCompileNormalCode():void
		{
            ...
            {
				var normalMatrix:Vector.<ShaderRegisterElement> = VectorInit.AnyClass( 3 );
