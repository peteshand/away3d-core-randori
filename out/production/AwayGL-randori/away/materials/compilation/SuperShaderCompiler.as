...
package away.materials.compilation
{
	...
	public class SuperShaderCompiler extends ShaderCompiler
	{
		...
		override public function pInitLightData():void
		{
			...
			this._pointLightRegisters = VectorInit.AnyClass(this._pNumPointLights*3);//Vector.<ShaderRegisterElement>(_numPointLights*3, true);
            this._dirLightRegisters = VectorInit.AnyClass(this._pNumDirectionalLights*3);//Vector.<ShaderRegisterElement>(_numDirectionalLights*3, true);
		...
		{
			var normalMatrix:Vector.<ShaderRegisterElement> = VectorInit.AnyClass(3);//Vector.<ShaderRegisterElement> = new Vector.<ShaderRegisterElement>(3, true);
