...
package away.loaders
{
	...
	public class AssetLoader extends EventDispatcher
	{
		...
		private function retrieveNext(parser:ParserBase = null):void
		{
            ...
            {
                this.dispatchEvent( new LoaderEvent( LoaderEvent.RESOURCE_COMPLETE , this._uri , this._baseDependency.assets ));
		...
		private function retrieveDependency(dependency:ResourceDependency, parser:ParserBase = null):void
		{
			...
			if (data)
            {
				if ( this._loadingDependency.retrieveAsRawData)
                {
					...
					this.dispatchEvent(new LoaderEvent(LoaderEvent.DEPENDENCY_COMPLETE, this._loadingDependency.request.url, this._baseDependency.assets, true));
		...
		private function onRetrievalFailed(event:LoaderEvent):void
		{
			...
			event = new LoaderEvent(LoaderEvent.LOAD_ERROR, this._uri, this._baseDependency.assets, isDependency, event.message);
		...
		private function onRetrievalComplete(event:LoaderEvent):void
		{
			...
			this.dispatchEvent(new LoaderEvent(LoaderEvent.DEPENDENCY_COMPLETE, event.url, this._baseDependency.assets));
			this.removeEventListeners(loader);
