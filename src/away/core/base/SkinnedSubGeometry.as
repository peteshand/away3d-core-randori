...
package away.core.base
{
	...
	public class SkinnedSubGeometry extends CompactSubGeometry
	{
		...
		private var _jointWeightsBuffer:Vector.<VertexBuffer3D> = VectorInit.AnyClass(8);
		private var _jointIndexBuffer:Vector.<VertexBuffer3D> = VectorInit.AnyClass(8);
		...
		private var _jointWeightContext:Vector.<Context3D> = VectorInit.AnyClass(8);
		private var _jointIndexContext:Vector.<Context3D> = VectorInit.AnyClass(8);
