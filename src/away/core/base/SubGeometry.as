...
package away.core.base
{
	...
	public class SubGeometry extends SubGeometryBase implements ISubGeometry
	{
		...
		// buffers:
		private var _vertexBuffer:Vector.<VertexBuffer3D> = VectorInit.AnyClass( 8 );//Vector.<VertexBuffer3D> = VectorInit.AnyClass(8)
		private var _uvBuffer:Vector.<VertexBuffer3D> = VectorInit.AnyClass( 8 );//:Vector.<VertexBuffer3D> = VectorInit.AnyClass(8)
		private var _secondaryUvBuffer:Vector.<VertexBuffer3D> = VectorInit.AnyClass( 8 );//:Vector.<VertexBuffer3D> = VectorInit.AnyClass(8)
		private var _vertexNormalBuffer:Vector.<VertexBuffer3D> = VectorInit.AnyClass( 8 );//:Vector.<VertexBuffer3D> = VectorInit.AnyClass(8)
		private var _vertexTangentBuffer:Vector.<VertexBuffer3D> = VectorInit.AnyClass( 8 );//:Vector.<VertexBuffer3D> = VectorInit.AnyClass(8)

		// buffer dirty flags, per context:
		private var _vertexBufferContext:Vector.<Context3D> = VectorInit.AnyClass( 8 );//:Vector.<Context3D> = VectorInit.AnyClass(8)
		private var _uvBufferContext:Vector.<Context3D> = VectorInit.AnyClass( 8 );//:Vector.<Context3D> = VectorInit.AnyClass(8)
		private var _secondaryUvBufferContext:Vector.<Context3D> = VectorInit.AnyClass( 8 );//:Vector.<Context3D> = VectorInit.AnyClass(8)
		private var _vertexNormalBufferContext:Vector.<Context3D> = VectorInit.AnyClass( 8 );//:Vector.<Context3D> = VectorInit.AnyClass(8)
		private var _vertexTangentBufferContext:Vector.<Context3D> = VectorInit.AnyClass( 8 );//:Vector.<Context3D> = VectorInit.AnyClass(8)
