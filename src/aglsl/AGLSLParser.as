...
package aglsl
{
	public class AGLSLParser
	{
		...
		public function regtostring(regtype:Number, regnum:Number, desc:Description, tag):String
		{
			switch ( regtype )
			{
		...
		public function sourcetostring(s, subline, dwm, isscalar, desc, tag):String
		{
			var swiz = [ "x","y","z","w" ]; 
			var r;
